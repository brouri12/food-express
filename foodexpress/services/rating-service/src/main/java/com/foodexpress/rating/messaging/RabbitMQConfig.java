...
public class RabbitMQConfig {
    ...
    @Bean
    public ObjectMapper ratingObjectMapper() {
    ...
    public MessageConverter jsonMessageConverter() {
        return new Jackson2JsonMessageConverter(ratingObjectMapper());
    }

    @Bean
    public RabbitTemplate ratingRabbitTemplate(ConnectionFactory connectionFactory) {
